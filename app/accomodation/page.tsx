import AccomodationHero from "@/components/AccomodationHero";
import { AccomodationPageLinks } from "@/constants";
  ...
  return(
    <div className="w-full">
      ...
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold mb-5">Special Accommodation</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-10 px-14">
          {AccomodationPageLinks.map((room, index) => (
            <div key={index} className="relative bg-card rounded-lg overflow-hidden shadow-lg group">
              ...
              <div className="p-4 block">
                ...
                <h3 className="text-nav-200 font-bold text-xl">{room.price}</h3>
              </div>
            </div>
          ))}
        </div>
